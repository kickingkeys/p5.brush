#!/usr/bin/env python3
"""Build a standalone v3 gallery page (v3.html) — just the new run images."""
import json
...
def cell(mk: str, pid: str) -> str:
    entry = MANIFEST.get(f"{mk}__v3__{pid}", {})
...
<title>p5.brush Recipes v3 — gallery</title>
<style>
...
<h1>p5.brush Recipes v3 — gallery</h1>
<p class="lede">Just the v3 images from the 60-cell run (5 models × 12 prompts). v3 = v2 Recipes + Watercolor split into Form/Field sub-recipes + "When NOT to apply graduated density". For the side-by-side with old/v1/v2/v3, see <a href="index.html">index.html</a>.</p>
